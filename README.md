...
대구대학교 AI학과 "웹 프로그래밍" 수업 과제로 약 한 달간(2024.8.1~8.30) 혼자
기획·설계·구현한 Java 웹 쇼핑몰입니다. 카카오톡 이모티콘 캐릭터 굿즈를
온라인으로 판매하는 사이트를 만들었습니다.

## 기획 의도

좋아하는 카카오톡 이모티콘 관련 굿즈가 오프라인으로만 판매되는 것을 보고,
온라인 판매 사이트를 대신 만들어보기로 기획했습니다.

## 구현 범위

발표자료에 있는 화면 스크린샷 기준으로 실제 동작하는 기능은 다음과
같습니다.
...
이 프로젝트의 Java 소스 코드는 로컬에 별도로 보관되어 있지 않았습니다. 위
ERD·클래스 다이어그램·화면 스크린샷은 실제 발표자료에서 가져온 것입니다.
